...
contract PuppyRaffle is ERC721, Ownable {
    ...
    // @audit-info check zero values passing in constructor
    // @audut-info raffleDuration should be UNIX timestamp
    constructor(
        uint256 _entranceFee,
        address _feeAddress,
        uint256 _raffleDuration
    ) ERC721("Puppy Raffle", "PR") {
        //@report-written some input validation for zero params
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        // @report-written uint256 playerLength=player.length;
    ...
    function selectWinner() external {
        ...
        //@Report-written Weak Radomness
        // fixex : Chainlink VRF, Commit Reveal Scheme ?
        ...
        // @audit the winner wouldn't get the money if their fallback or receive messed up, incase if their wallet is a smart contract!
        // IMPACT: Medium
    ...
    function withdrawFees() external {
        ...
        // q what if the feeAddress is a smart contract with a fallback or receive that will fail ?
