...
// e should implement this inteface
    ...
    OracleUpgradeable
{
    ...
    mapping(IERC20 => AssetToken) public s_tokenToAssetToken; // e I think this maps the underlying token to its assestToken
    ...
    mapping(IERC20 token => bool currentlyFlashLoaning)
        private s_currentlyFlashLoaning; // e probably a mapping that tells us if a token is in the middle of a flash loan
    ...
    // @audit-info change the name of param to poolFactoryAddress
    // q what if we deploy the contract, and someone else intializes it ?
    // a that would suck
    // They could pick a different tswapAddress !!!
    // @audit-low intializers can be front run
    ...
    // @aduit-info where is the natspec????
    ...
    function deposit(
        ...
        // e exchangeRate should never be 0 because of the asset token conditional
    ...
    function flashloan(
        ...
        // @follow-up reentrancy
        // @follow-u do we need the return value ?
