...
contract AssetToken is ERC20 {
    ...
    constructor(
        ...
        // oh, are the ERCs20 stored in AssetToken.sol instead of ThunderLoan?
    ...
    function transferUnderlyingTo(
        ...
        // q what happen if USDC blacklists the AssetToken contract ?
        // @follow-up weird ERC20S With USDC

        i_underlying.safeTransfer(to, amount);
    }

    // e is responsible for updating the exchange rate of AssetToken -> Underlying
    function updateExchangeRate(uint256 fee) external onlyThunderLoan {
        ...
        // q what if totalSuppy is 0?
        // this break! is that an issue?

        // @audit -gas, too many storage reads of s_exchangeRate -> store as a memory variable
