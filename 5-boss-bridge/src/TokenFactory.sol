...
contract TokenFactory is Ownable {
    ...
    function deployToken(
        ...
        assembly {
            // X large
            // load the contract bytecode inot memory
            // create a contract

            // @audit0-high thi won't work on ZKsync!!
            // https://docs.zksync.io/zksync-era/unique-features/evm-interpreter/evm-interpreter
            // Test this on zkSync
            addr := create(
                0,
